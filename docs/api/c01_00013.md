---
title:  用户管理_服务端API
description: 对用户相关操作的接口说明，api接口包括创建用户，更新用户，更新部门职务信息，删除用户，批量删除用户，获取用户信息，获取部门用户详细信息，获取部门用户，设置、获取用户头像，更新下次登录修改密码开关
...
POST方式请求URL:
http://[SERVER:7080]/cgi/user/pwd/changeswitchupdate?accessToken=$access_token
